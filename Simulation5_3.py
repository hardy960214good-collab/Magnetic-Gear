...
g14 = cylinder(pos=vec(-d/2,0,0),axis=vec(l,0,0),color=color1,radius=r/2)
g15 = cylinder(pos=vec(-d/2,0,0),axis=vec(l,0,0),color=color1,radius=r/2)
...
for n in data:
    ...
    g12.axis=vec(l*np.cos(the1+np.radians(72)),0,l*np.sin(the1+np.radians(72)))
    g13.axis=vec(l*np.cos(the1+2*np.radians(72)),0,l*np.sin(the1+2*np.radians(72)))
    g14.axis=vec(l*np.cos(the1-2*np.radians(72)),0,l*np.sin(the1-2*np.radians(72)))
    g15.axis=vec(l*np.cos(the1-np.radians(72)),0,l*np.sin(the1-np.radians(72)))
